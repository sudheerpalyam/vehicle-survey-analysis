...
public class VehicleHit {
	...
	public String toString() {
		...
		return "VehicleHit [data=" + data + ", recordedTimeMills=" + recordedTimeMills + ", epochTimeMills="
				+ epochTimeMills + ", epochTime="
				+ TimeUtil.df.format(Instant.ofEpochMilli(epochTimeMills)) + 
				", day=" + day + ", bound=" + bound + ", timeSinceMidNight=" + timeSinceMidNight + "]";
	}
